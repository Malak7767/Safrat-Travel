...
const ARABIC_RESPONSES = {
  default: { text: "أهلاً! 👋 أنا سفرات، مساعدك الشخصي للسفر.\n\nأخبرني أين تحلم بالسفر — الوجهة، التواريخ، الميزانية، وأسلوب سفرك — وسأبني لك خطة رحلة متكاملة.", tripCard: null },
  beach: { text: "اختيار رائع! 🌊 سنتوريني في اليونان وجهة حالمة تجمع بين الشواطئ الصافية والغروب الأسطوري.\n\nأقوم الآن بالبحث عن أفضل الفنادق الفاخرة لك...\n\n**✓ كانافيس أويا إيبيتوم** - 5 ليالٍ بإطلالة على البحر\n**✓ طيران الإمارات** - درجة رجال الأعمال\n**✓ جولة خاصة في القرى التقليدية**\n\nالتكلفة الإجمالية المتوقعة: **$8,500**", tripCard: null },
  mountain: { text: "خيار مميز! 🏔️ جبال الألب السويسرية في يوليو رائعة للمغامرة.\n\nأبحث لك عن أفضل المنتجعات الجبلية الفاخرة...\n\n**✓ منتجع زيرمات الفاخر** - 8 ليالٍ\n**✓ الخطوط السويسرية** - درجة الأعمال\n**✓ جولات مع مرشد خاص يومياً**\n\nالتكلفة الإجمالية المتوقعة: **$14,200**", tripCard: 0 },
  romantic: { text: "ما أجمل هذا! 💑 الساحل الأمالفي في إيطاليا وجهة رومانسية لا تُنسى.\n\nأقوم بإعداد تجربة مخصصة للأزواج...\n\n**✓ فيلا تريفيل أمالفي** - 6 ليالٍ على المنحدر\n**✓ عشاء خاص على الشاطئ تحت النجوم**\n**✓ جولة بالقارب على طول الساحل**\n\nالتكلفة الإجمالية المتوقعة: **$11,200**", tripCard: null },
  family: { text: "رائع! 👨‍👩‍👧‍👦 رحلة عائلية لا تُنسى تنتظركم.\n\nأبحث عن أفضل الوجهات المناسبة للعائلات...\n\n**✓ فندق 5 نجوم مع نادٍ للأطفال**\n**✓ أنشطة ترفيهية يومية للجميع**\n**✓ وجبات متنوعة تناسب الأطفال**\n\nالتكلفة الإجمالية المتوقعة: **$12,400**", tripCard: 3 },
  cultural: { text: "اختيار ثقافي رائع! 🏯 كيوتو مدينة التاريخ والجمال.\n\nأجهز لك تجربة ثقافية أصيلة...\n\n**✓ جولات المعابد التاريخية**\n**✓ تجربة حفل الشاي الياباني الأصيل**\n**✓ مرشد خاص يتحدث العربية**\n\nالتكلفة الإجمالية المتوقعة: **$7,200**", tripCard: 4 },
}

const FRENCH_RESPONSES = {
  default: { text: "Bonjour! 👋 Je suis Safrat, votre conseiller voyage IA personnel.\n\nDites-moi où vous rêvez d'aller — destination, dates, budget, style de voyage — et je construirai un itinéraire entièrement personnalisé pour vous.", tripCard: null },
  beach: { text: "Excellent choix! 🌊 Santorin en Grèce est une destination de rêve avec ses plages cristallines et ses couchers de soleil légendaires.\n\nJe recherche les meilleurs hôtels de luxe pour vous...\n\n**✓ Canaves Oia Epitome** - 5 nuits avec vue sur la caldeira\n**✓ Swiss Air** - Classe Affaires\n**✓ Transfert privé en bateau**\n\nCoût total estimé: **$8,500**", tripCard: null },
  mountain: { text: "Magnifique! 🏔️ Les Alpes suisses en juillet sont parfaites pour l'aventure.\n\nJe recherche les meilleurs lodges de montagne pour vous...\n\n**✓ Resort de luxe à Zermatt** - 8 nuits\n**✓ Swiss Air** - Classe Affaires\n**✓ Guide privé chaque jour**\n\nCoût total estimé: **$14,200**", tripCard: 0 },
  romantic: { text: "Quelle belle idée! 💑 La Côte Amalfitaine en Italie est la destination romantique par excellence.\n\nJe prépare une expérience sur mesure pour vous deux...\n\n**✓ Villa Treville Amalfi** - 6 nuits sur la falaise\n**✓ Dîner privé sur la plage sous les étoiles**\n**✓ Croisière privée le long de la côte**\n\nCoût total estimé: **$11,200**", tripCard: null },
  family: { text: "Parfait! 👨‍👩‍👧‍👦 Un voyage en famille inoubliable vous attend.\n\nJe recherche les meilleures destinations familiales...\n\n**✓ Hôtel 5 étoiles avec club enfants**\n**✓ Activités quotidiennes pour toute la famille**\n**✓ Menus adaptés aux enfants**\n\nCoût total estimé: **$12,400**", tripCard: 3 },
  cultural: { text: "Excellent choix culturel! 🏯 Kyoto, la ville de l'histoire et de la beauté japonaise.\n\nJe prépare une expérience culturelle authentique...\n\n**✓ Visites des temples historiques**\n**✓ Cérémonie du thé japonaise traditionnelle**\n**✓ Guide privé francophone**\n\nCoût total estimé: **$7,200**", tripCard: 4 },
}
...
function getFrenchResponse(text) {
  ...
  if (l.includes('plage') || l.includes('santorin') || l.includes('mer') || l.includes('île') || l.includes('grèce')) return FRENCH_RESPONSES.beach
  if (l.includes('montagne') || l.includes('alpes') || l.includes('suisse') || l.includes('ski')) return FRENCH_RESPONSES.mountain
  if (l.includes('romantique') || l.includes('lune de miel') || l.includes('couple') || l.includes('amalfi')) return FRENCH_RESPONSES.romantic
  if (l.includes('famille') || l.includes('enfants')) return FRENCH_RESPONSES.family
  if (l.includes('culture') || l.includes('kyoto') || l.includes('japon') || l.includes('temple')) return FRENCH_RESPONSES.cultural
...
function getAIResponse(text) {
  ...
  if (l.includes('cultur') || l.includes('kyoto') || l.includes('japan') || l.includes('flight to japan') || l.includes('museum')) return AI_RESPONSES.cultural
...
export default function ChatPanel({ trip, onBookNow, onItineraryUpdate }) {
  ...
  // ✅ heroTrip: starts as the selected trip (if any), updates when AI recommends one
  const [heroTrip, setHeroTrip] = useState(trip || null)

  const endRef = useRef(null)

  // If user switches to a different trip from the sidebar, reset everything
  useEffect(() => {
    setMessages(trip ? (TRIP_CHAT_MESSAGES[trip.id] || CHAT_MESSAGES) : WELCOME_MESSAGES)
    setHeroTrip(trip || null)
  }, [trip?.id])
  ...
  const send = async (text) => {
    ...
    // ✅ If AI recommends a trip card, update the hero immediately
    if (response.tripCard !== null && response.tripCard !== undefined) {
      setHeroTrip(TRIPS[response.tripCard])
    }

    // Kyoto itinerary panel update
    const isKyoto =
      ...
      text.toLowerCase().includes('japan') || text.toLowerCase().includes('flight to japan') ||
      text.toLowerCase().includes('culture') ||
      (isFrench(text) && (text.toLowerCase().includes('kyoto') || text.toLowerCase().includes('japon')))
  ...
  // The displayed hero — heroTrip covers both existing trip and newly recommended one
  const displayHero = heroTrip
    ...
    <div className="chat-panel">
      ...
      <div className="chat-topbar">
        <div className="chat-topbar__left">
          ...
          <div>
            <p className="chat-topbar__name">{displayHero?.title || 'New Conversation'}</p>
      ...
      {/* ✅ Trip hero — shows for existing trip OR after AI recommends one */}
      {displayHero && (
        <div className="trip-hero">
          <img
            src={displayHero.image}
            alt={displayHero.destination}
          ...
          <div className="trip-hero__content">
            <p className="trip-hero__location">
              ...
              {displayHero.destination}
            </p>
            <h2 className="trip-hero__title">{displayHero.title}</h2>
            <div className="trip-hero__stats">
              <div className="trip-hero__stat">
                ...
                <span>Duration</span><strong>{displayHero.days} Days</strong>
              </div>
              <div className="trip-hero__stat">
                ...
                <span>Lodging</span><strong>{displayHero.tags[0]}</strong>
              </div>
              <div className="trip-hero__stat">
              ...
              <div className="trip-hero__price">{displayHero.budget}</div>
            </div>
          </div>
        </div>
      )}
